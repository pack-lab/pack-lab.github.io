...
### Testing Facility
* [Drone Cage](./DroneCage.md): 7.2 m x 7.2 m x 4 m, with 12 OptiTrack Flex 13 Cameras (Accuracy: ±0.5mm, frame rate: 120 FPS)

### Computational Platform
* Dell Precision 7920 Tower: CPU: Intel Xeon Silver 4216, GPU: Nvidia RTX A4500 (x2)    
* Mac Studios: M2 Ultra 24-core CPU, 60-core GPU, 32-core Neural Engine, 128-GB Unified Memory
* Desktops: CPU: Intel i7-12700/i7-14700, GPU: Nvidia GeForce RTX 3090/4060
* HPC Nodes: CPU: Intel Xeon E5-2680 CPUs (28-core), GPU: NVIDIA GeForce RTX 2080 Ti (x4), RAM: 512 GB
